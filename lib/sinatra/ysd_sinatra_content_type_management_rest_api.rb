  ...
  module YSD
    ...
    module ContentTypeManagementRESTApi
      ...
      def self.registered(app)
        ...
        #
        app.get "/api/content-types", :allowed_usergroups => ['staff','webmaster'] do
          content_type :json
        ...
        #
        app.get "/api/content-type/:id", :allowed_usergroups => ['staff','webmaster'] do
        ...
        #
        app.post "/api/content-type", :allowed_usergroups => ['staff','webmaster'] do
        ...
        #
        app.put "/api/content-type", :allowed_usergroups => ['staff','webmaster'] do
        ...
        #
        app.delete "/api/content-type", :allowed_usergroups => ['staff','webmaster'] do
        ...
        #
        app.get "/api/content-type/:content_type/:aspect/config", :allowed_usergroups => ['staff','webmaster'] do
        ...
        #
        app.put "/api/content-type/:content_type/:aspect/config", :allowed_usergroups => ['staff','webmaster'] do
