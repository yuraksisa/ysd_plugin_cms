    ...
    def routes(context={})
      ...
      routes = [{:path => '/admin/site/cms/content-types',
                ...
                {:path => '/mctype/:type/:aspect',
                 ...
                 :module => :cms},                 
                {:path => '/admin/contents',
                 :regular_expression => /^\/admin\/content/, 
                 :title => 'Content', 
                ...
                {:path => '/admin/site/cms/new/content/:content_type',
                 ...
                 :fit => 1,
                 :module => :cms},                 
                {:path => '/edit/content/:content_id',
                 :regular_expression => /^\/edit\/content\/.+/, 
                 :title => 'Edit content', 
